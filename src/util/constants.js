...
const CODE_BLOCK_LANG_MERMAID = 'mermaid'

const ALERT_TYPES = ['NOTE', 'TIP', 'IMPORTANT', 'WARNING', 'CAUTION']

const MENTION_PREFIX = '@'
const ISSUE_REF_PREFIX = '#'
const EMOJI_DELIMITER = ':'
const MATH_INLINE_DELIMITER = '$'
...
module.exports = {
  ...
  CODE_BLOCK_LANG_YAML,
  CODE_BLOCK_LANG_SQL,
  CODE_BLOCK_LANG_MARKDOWN,
  CODE_BLOCK_LANG_HTML,
  CODE_BLOCK_LANG_CSS,
  CODE_BLOCK_TOPOJSON,
  CODE_BLOCK_LANG_MERMAID,
  ALERT_TYPES,
  TASK_LIST_PREFIX,
